...
func (fakeUpstreamAttemptPolicy) OnUpstreamAttemptRequest(_ context.Context, actx *UpstreamAttemptContext) UpstreamAttemptAction {
	if actx.AttemptCount <= 1 {
		return UpstreamAttemptRequestModifications{}
	}
	return UpstreamAttemptRequestModifications{HeadersToSet: map[string]string{"Authorization": "Bearer refreshed"}}
}
...
func TestUpstreamAttemptContext_AttemptCountGatesRefresh(t *testing.T) {
	...
	action := p.OnUpstreamAttemptRequest(context.Background(), attemptOne)
	mods, ok := action.(UpstreamAttemptRequestModifications)
	...
	action2 := p.OnUpstreamAttemptRequest(context.Background(), attemptTwo)
	mods2, ok := action2.(UpstreamAttemptRequestModifications)
...
func TestUpstreamAttemptRequestModifications_BodyFieldExists(t *testing.T) {
	mods := UpstreamAttemptRequestModifications{
...
func (stubAttemptPolicy) OnUpstreamAttemptRequest(_ context.Context, actx *UpstreamAttemptContext) UpstreamAttemptAction {
	return UpstreamAttemptRequestModifications{}
}
