...
- [FR6: OAuth2 Upstream Authentication](prds/oauth2-upstream-auth.md) – Authenticate outbound requests to OAuth2-secured LLM providers/proxies via a first-party policy, with two-tier Redis-backed token caching.
