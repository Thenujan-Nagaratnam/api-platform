...
// oauth2ConfigDiscriminator in gateway/dev-policies/oauth2/token_cache.go).
//
		...
		Spec: api.LLMProxyConfigData{
			...
			Provider: api.LLMProxyProvider{
				...
				Auth: &api.LLMUpstreamAuth{
					...
					Oauth2TokenEndpoint: stringPtr("https://idp-a.example.com/token"),
					Oauth2ClientId:      stringPtr("client-a"),
					Oauth2ClientSecret:  stringPtr("secret-a"),
				},
			},
			AdditionalProviders: &[]api.LLMProxyAdditionalProvider{{
				Id: "provider-b",
				Auth: &api.LLMUpstreamAuth{
					Type:                api.LLMUpstreamAuthTypeOauth2,
					Oauth2TokenEndpoint: stringPtr("https://idp-b.example.com/token"),
					Oauth2ClientId:      stringPtr("client-b"),
					Oauth2ClientSecret:  stringPtr("secret-b"),
				},
			}},
		},
	}
